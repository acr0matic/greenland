    ...
    <div class="container">
      ...
      <div class="catalog-list">
          ...
          <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
            <div class="catalog-card">
              <picture class="catalog-card__picture">
                <img class="image image--cover" src="content/catalog/card/1.jpg" alt="">
              </picture>

              <div class="catalog-card__wrapper">
                <div class="catalog-card__content">
                  <h3 class="catalog-card__title">Номер 3</h3>
                  <div class="catalog-card__price">от 1900 руб/сутки</div>
                </div>
                <!-- /.catalog-card__content -->

                <div class="catalog-card__people catalog-card__list">
                  <div>
        ...
        <p class="catalog-list__text">
          Современный отель «Green Land» - это сказочный дом, наполненный теплом.
          Уютное лобби с камином, красочная детская игровая комната, светлый ресторан, спортзал, бильярд, боксерский ринг и 8 дизайнерский номеров лаконично расположились на трех этажах отеля.
        </p>
      </div>
      <!-- /.catalog-list -->
    </div>
